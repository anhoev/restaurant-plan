...
public class demoBioMini extends JFrame {
    ...
    static demoBioMini pMainInstance;
    ...
    public int testCallStartCapturing() {
        ...
        nRes = p.UFS_StartAutoCapture(hScanner[0], "captureCallback");
...
//			getParameter
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (nRes == 0) {
                        ...
                        MsgBox("Scanner Init success!!");
                                                         ...
                                                         */
                        p.UFS_SetClassName("demoBioMini");
        ...
        if (jButton_save_tmp == null) {
            ...
            jButton_save_tmp.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    int returnVal = fc.showSaveDialog(demoBioMini.this);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                demoBioMini thisClass = new demoBioMini();
